...
export default class EntityTable extends React.PureComponent {
    render() {
        ...
        const entities = [{...properties}, ...(properties.relationships || []).map(({target}) => target.entity)];
        ...
        return (
            ...
            >
                <TableHeader>
                    ...
                    />
                    <TableHeaderCell value={({ item }) => item.name} alignmentType={TableRowCell.ALIGNMENT_TYPE.LEFT}>
                        Name
                    </TableHeaderCell>
